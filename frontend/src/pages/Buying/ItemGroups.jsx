    ...
    return (
      <Card className={`bg-gradient-to-br ${colorMap[color] || colorMap.primary} p-4 border-2 transition-all hover:shadow-lg`}>
        <div className="flex items-start justify-between relative z-10">
          ...
          <div className="p-2 rounded  bg-white dark:bg-slate-900   border border-inherit">
  ...
  return (
    <div className="w-full bg-slate-50 dark:bg-slate-950 min-h-screen p-4 transition-colors duration-300">
      <div className="max-w-[1200px] mx-auto space-y-2">
        ...
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 bg-white dark:bg-slate-900 p-6 rounded  border border-slate-200 dark:border-slate-800  ">
          <div className="flex items-center gap-4">
            <div className="bg-indigo-600 p-3 rounded   shadow-indigo-600/20">
            ...
            <div>
              ...
              <h1 className="text-2xl  text-slate-900 dark:text-white ">Item Groups</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button 
              ...
              variant="primary"
              className="flex items-center gap-2 p-2   rounded  text-xs  shadow  shadow-indigo-600/20 transition-all bg-indigo-600 hover:bg-indigo-700 border-none"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            ...
            <div className="flex gap-3 justify-end pt-4">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="px-8 py-2  rounded  text-xs   shadow-indigo-600/20 bg-indigo-600 hover:bg-indigo-700 border-none"
              >
