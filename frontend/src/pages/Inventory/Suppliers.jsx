...
import { Plus, Edit2, Trash2, X, Check, Users, Grid3x3, List, Star, Search, Filter, Eye, ChevronRight, RefreshCw } from 'lucide-react'
    ...
    { 
      ...
      render: (val) => (
        <div className="flex items-center gap-1">
          ...
          <span className="font-medium">{val || '0.0'}</span>
        </div>
      )
    },
    { 
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 my-4">
          <div className="relative flex-1 group">
            ...
            <input 
              ...
              className="w-full pl-11 pr-4 py-2 bg-white border border-slate-200 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-xs font-medium"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 ">
              ...
              <div className="h-4 w-fit bg-slate-200 mx-1"></div>
              <select 
            ...
            <div className="flex items-center gap-2 ">
              <span className="text-[11px] font-medium text-slate-500 whitespace-nowrap">Group:</span>
              <select 
                value={filters.group}
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2  text-xs font-medium text-slate-600 hover:border-indigo-500 hover:text-indigo-600 transition-all p-2 border border-slate-200 rounded"
              >
                <Eye size={14} />
                <span>Columns</span>
                  ...
                  <div className="max-h-60 overflow-y-auto">
                    {columns.map(col => (
                      <label key={col.key} className="flex items-center gap-2 px-3 py-1.5 hover:bg-slate-50 cursor-pointer">
                        ...
                        />
                        <span className="text-[11px] text-slate-600">{col.label}</span>
                      </label>
                    ))}
                  </div>
                </div>
