            ...
            <div className="bg-slate-50 p-5 rounded  border border-slate-200 space-y-4">
              <div className="flex justify-between items-start border-b border-slate-200 pb-3 mb-2">
                ...
                <div className="text-right">
                  <div className="text-[10px]  text-slate-400   mb-1">Created On</div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm  text-slate-800">{order.customer_name || 'N/A'}</div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-[10px]  text-slate-400  ">Quotation ID</div>
          ...
          <div className="lg:w-2/3 space-y-2">
            ...
            {order.order_terms && (
              <div className="bg-slate-50 p-6 rounded  border border-slate-200">
                ...
                <div className="text-sm text-slate-600 leading-relaxed bg-white p-4 rounded  border border-slate-100 whitespace-pre-wrap">
                  {order.order_terms}
                </div>
              </div>
            )}
