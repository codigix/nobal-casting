                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        required
                        className="w-full pl-10 pr-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-all text-sm font-bold text-blue-600 shadow-sm"
                      />
                    </div>
                  </div>
                </div>
          ...
          <div className="lg:w-3/5 space-y-6">
                ...
                <table className="w-full text-sm">
                  <thead className="bg-slate-50/50 text-slate-500 sticky top-0 backdrop-blur-sm">
                    <tr>
                      ...
                      <th className="px-5 py-3 text-center font-bold uppercase tracking-wider text-[10px]">Ordered Qty</th>
                    </tr>
                  </thead>
                      ...
                      selectedOrder.items.map((item, idx) => (
                        <tr key={idx} className="hover:bg-slate-50/50 transition-colors">
                          ...
                          <td className="px-5 py-3 text-center">
                            <span className="px-2 py-1 bg-blue-50 text-blue-700 rounded font-bold">{item.qty}</span>
                          </td>
                        </tr>
                      ))
                    ) : (
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                className="w-full p-2  border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition-all text-sm shadow-sm resize-none bg-slate-50/30"
              />
            </div>
