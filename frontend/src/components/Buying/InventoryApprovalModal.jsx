    ...
    >
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="p-4 bg-neutral-50 border border-neutral-100 rounded ">
            <div className="flex items-center gap-2 mb-2">
              <Truck size={14} className="text-neutral-400" />
              <p className="text-[10px] text-neutral-500  tracking-wider">Reference</p>
            </div>
            <p className="text-sm  text-neutral-800">PO: {grn.po_no}</p>
          ...
          <div className="p-4 bg-emerald-50 border border-emerald-100 rounded ">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-[10px] text-emerald-600  tracking-wider">Total Accepted</p>
            </div>
            <p className="text-xl  text-emerald-700">{totalAccepted}</p>
          </div>

          <div className="md:col-span-2 p-4 bg-primary-600 rounded  text-white  shadow-primary-100 flex justify-between items-center">
            <div>
              <div className="flex items-center gap-2 mb-1">
                <TrendingUp size={14} className="text-primary-100" />
                <p className="text-[10px] text-primary-100  tracking-wider">Total Valuation Value</p>
              </div>
        ...
        <section className="bg-white rounded  border border-neutral-200 overflow-hidden  ">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-[11px]">
              <thead className="bg-neutral-50 text-neutral-500   tracking-wider border-b border-neutral-200">
                <tr>
                  ...
                  approvalItems.map((item) => {
                    ...
                    return (
                      <tr key={item.id} className="hover:bg-neutral-50/50 transition-colors">
                        <td className="p-2 ">
                          <div className=" text-neutral-900">{grnItem.item_code}</div>
                          <div className="text-[10px] text-neutral-400 font-medium truncate max-w-[150px]">{grnItem.item_name}</div>
                        </td>
                        <td className="px-2 py-3 text-center  text-neutral-700 bg-neutral-50/30">
                        ...
                        <td className="px-2 py-3">
                          <input
                            ...
                            className="w-full px-2 py-1.5 bg-white border border-neutral-200 rounded text-center  text-primary-600 focus:ring-2 focus:ring-primary-500 outline-none"
                          />
                        </td>
                        <td className="px-2 py-3">
                          <input
                            ...
                            className="w-full px-2 py-1.5 bg-white border border-neutral-200 rounded text-center  text-red-500 focus:ring-2 focus:ring-red-500 outline-none"
                          />
                        </td>
                        <td className="px-2 py-3">
                          <select
                        ...
                        <td className="p-2  text-right">
                          <input
                            ...
                            className="w-full px-2 py-1.5 bg-white border border-neutral-200 rounded text-right  text-neutral-700 focus:ring-2 focus:ring-primary-500 outline-none"
                          />
                        </td>
                      </tr>
                    )
