...
router.get('/project-dispatch-report', MastersController.getProjectDispatchReport)
router.get('/individual-dispatches', MastersController.getIndividualDispatches)
router.get('/project-material-report', MastersController.getProjectMaterialReport)
router.get('/project-material-report/:id', MastersController.getProjectDetailedMaterialReport)
